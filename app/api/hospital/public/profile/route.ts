  ...
  try {
    ...
    return successResponse(
      serializeDoc({
        ...
        heroImageUrl: hospital.heroImageUrl,
        phone: hospital.publicPhone || hospital.ownerPhone,
        email: hospital.publicEmail || hospital.ownerEmail,
        emergencyPhone: hospital.settings?.emergencyContact || hospital.publicPhone || hospital.ownerPhone,
        workingHours: hospital.settings?.workingHours,
